...
public:
    ...
    PrefixSettings->resize(720, 445);
    PrefixSettings->setMinimumSize(QSize(340, 370));
    ...
    vboxLayout3 = new QVBoxLayout(groupBox_5);
    ...
    vboxLayout3->addWidget(widget_15);
    ...
    vboxLayout3->addWidget(widget_16);
    ...
    spacerItem1 = new QSpacerItem(680, 21, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    vboxLayout5 = new QVBoxLayout(tab);
    ...
    vboxLayout6->addWidget(widget_2);
    ...
    vboxLayout6->addWidget(widget_4);
    ...
    vboxLayout6->addWidget(widget_10);
    ...
    vboxLayout6->addWidget(widget_11);


    vboxLayout5->addWidget(groupBox);

    spacerItem2 = new QSpacerItem(680, 31, QSizePolicy::Minimum, QSizePolicy::Expanding);
