...
void Registry::set(const QString &path, const QString &key, const QString &value, const QString &hkey){
    QString regString;
    regString.append("\n\n[");
...
void Registry::unset(const QString &path, const QString &key, const QString &hkey){
    QString regString;
    regString.append("\n\n[");
    regString.append(hkey);
    regString.append("\\");
...
bool Registry::exec(QObject *parent, const QString &prefix_path, const QString &prefix_name, const QString &post_run){
