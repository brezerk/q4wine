...
class MainWindow : public QMainWindow, public Ui::MainWindow {
  Q_OBJECT
 public:
  MainWindow(const int startState, const QString &run_binary,
 ...
 private slots:
   ...
   */
  void updateIconDesc(const QString &program, QString args, const QString &desc,
                      const QString &console, const QString &desktop);
  ...
  void mainVersionManager_Click(void);
